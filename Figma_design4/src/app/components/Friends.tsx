    ...
    <div className="h-full flex flex-col bg-white">
      ...
      <div className="px-6 py-6 border-b border-gray-200">
        <div className="flex items-center justify-between mb-3">
          <h1 className="text-2xl">ClassMates</h1>
          <button
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-[#4169E1] text-white text-xs font-medium rounded-lg hover:bg-[#3557c7] transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="p-1.5 bg-[#4169E1] text-white rounded-lg hover:bg-[#3557c7] transition-colors"
                    >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="p-2 bg-[#4169E1] text-white rounded-lg hover:bg-[#3557c7] transition-colors"
                      >
