...
export default function TimetableScreen({
  ...
  const timetableHeight = Math.max(420, screenHeight - 290);
          ...
          >
              ...
              return courseDays.map((day) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Text style={{ color: 'white', fontSize: 8 }} numberOfLines={1}>
                      {course.time}
                    </Text>
                    <Text style={{ color: 'white', fontSize: 8 }} numberOfLines={1}>
                      {course.professor}
            ...
            {previewCourse &&
              getDaysArray(previewCourse.days).map((day) => {
                ...
                const startHour = getCourseStartHour(previewCourse.time);
                const endHour = getCourseEndHour(previewCourse.time);
