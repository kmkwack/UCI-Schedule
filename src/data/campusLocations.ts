...
const CLASSROOM_LOCATIONS: Record<string, LocationMatcher[]> = {
  'UC Irvine': [
    ...
    { code: 'HICF', name: 'Humanities Interim Classroom Facility', latitude: 33.646908, longitude: -117.84687, aliases: ['HICF', 'HUMANITIES INTERIM CLASSROOM FACILITY'] },
    ...
    { code: 'ICS2', name: 'Donald Bren Hall II', latitude: 33.643200, longitude: -117.841500, aliases: ['ICS2', 'DONALD BREN HALL II', 'ICS 2'] },
    { code: 'WSH', name: 'Winifred Smith Hall', latitude: 33.649100, longitude: -117.845600, aliases: ['WSH', 'WINIFRED SMITH HALL'] },
    { code: 'ON', name: 'Online', latitude: 0, longitude: 0, aliases: ['ON', 'ONLINE'] },
    { code: 'VRTL', name: 'Virtual', latitude: 0, longitude: 0, aliases: ['VRTL', 'VIRTUAL'] },
