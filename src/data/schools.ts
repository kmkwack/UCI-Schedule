...
const PURDUE_SPORTS_PAGES: Extract<SportsFeedConfig, { kind: 'schedule-pages' }>['pages'] = [
  ...
  { sport: "Men's Swimming & Diving", path: '/sports/mens-swimming-and-diving/schedule', parser: 'wmt-schedule' },
  { sport: "Women's Swimming & Diving", path: '/sports/womens-swimming-and-diving/schedule', parser: 'wmt-schedule' },
  ...
  { sport: 'Track & Field', path: '/sports/track-and-field/schedule', parser: 'wmt-schedule' },
