        ...
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="ml-auto p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600 transition-colors"
            >
        ...
        <div className="px-6 py-4">
          ...
          <div className="flex items-center gap-2 pt-3 border-t border-gray-200">
            <input
              ...
              className="flex-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-full text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <button
