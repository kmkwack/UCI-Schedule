...
export const SCHOOL_CONFIGS: Record<string, SchoolConfig> = {
  ...
  'UC Riverside': {
    ...
    features: { ...DEFAULT_FEATURES, sports: true },
    sportsFeed: { kind: 'sidearm-components', url: 'https://gohighlanders.com/calendar' },
    gradeScale: STANDARD_40_SCALE,
  },
  'Northeastern University': {
    ...
    terms: ['Spring', 'Summer', 'Fall'],
    features: { ...DEFAULT_FEATURES, sports: true },
    sportsFeed: { kind: 'sidearm-components', url: 'https://nuhuskies.com/calendar' },
    gradeScale: STANDARD_40_SCALE,
  },
  'Temple University': {
    id: 'temple',
    ...
    terms: ['Spring', 'Summer', 'Fall'],
    features: { ...DEFAULT_FEATURES, sports: true },
    sportsFeed: { kind: 'sidearm-components', url: 'https://owlsports.com/calendar' },
    gradeScale: STANDARD_40_SCALE,
  },
  'Georgia State University': {
    ...
    terms: ['Spring', 'Summer', 'Fall'],
    features: { ...DEFAULT_FEATURES, sports: true },
    sportsFeed: { kind: 'sidearm-components', url: 'https://georgiastatesports.com/calendar' },
    gradeScale: STANDARD_40_SCALE,
  },
};
