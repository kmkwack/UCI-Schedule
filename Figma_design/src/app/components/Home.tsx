import { Cloud, Calendar, Trophy, Dribbble, Sparkles } from "lucide-react";
      ...
      <div className="space-y-4">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl p-6">
          <div className="flex items-start justify-between">
            <div>
              <h2 className="text-sm text-blue-900/60 mb-2">Weather</h2>
              <p className="text-3xl mb-1">22°</p>
              <p className="text-blue-900/70">Partly Cloudy</p>
            </div>
            <Cloud className="w-12 h-12 text-blue-500/40" strokeWidth={1.5} />
          </div>
        </div>
